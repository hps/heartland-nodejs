...
ct.CardDetailsType = {	// This type is not a defined ComplexType in the Portico Docs... It probably should be
	type: 'object',
	properties: {
...
ct.CardDataType = {
	...
	properties: {
		...
		'ManualEntry': 			ct.CardDetailsType,
		'TokenData': 			ct.CardDetailsType,
