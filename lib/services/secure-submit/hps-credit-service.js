                        ...
                        for (i = 0, len = _.get(b, 'ReportActivity.Details.length', 0); i < len; i++) {
                            ...
                            if (!filterBy || t.ServiceName === serviceName) {
                                transactionList.push({
                                    ...
                                    responseCode: isEmptyObject(t.IssuerRspCode)?(isEmptyObject(t.GatewayRspCode)?'':t.GatewayRspCode):t.IssuerRspCode,
                                    responseText: isEmptyObject(t.IssuerRspText)?(isEmptyObject(t.GatewayRspMsg)?'':t.GatewayRspMsg):t.IssuerRspText,
                                    amount: t.Amt,
